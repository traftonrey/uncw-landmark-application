...
## How to use?
Once the repo is setup in an IDE of choice, simply run it. This application works best when using a real mobile device, or an Android/iOS emulator. The application also works on web (Chrome tested) without the functionality of Google Maps.
